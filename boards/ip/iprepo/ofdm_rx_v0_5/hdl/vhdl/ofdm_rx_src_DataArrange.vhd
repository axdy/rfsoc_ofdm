...
ARCHITECTURE rtl OF ofdm_rx_src_DataArrange IS
  ...
  SIGNAL out_2_pipe_in_pipe_reg           : std_logic_vector(0 TO 64);  -- ufix1 [65]
...
BEGIN
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        preambleValidIn_2 <= preambleValidIn_1;
      END IF;
    END IF;
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_12_1 = '1' THEN
        preambleValidIn_3 <= preambleValidIn_2;
      END IF;
    END IF;
  ...
  BEGIN
    IF reset = '1' THEN
      out_2_pipe_in_pipe_reg <= (OTHERS => '0');
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_12_0 = '1' THEN
        out_2_pipe_in_pipe_reg(0) <= preambleValidIn_3;
        out_2_pipe_in_pipe_reg(1 TO 64) <= out_2_pipe_in_pipe_reg(0 TO 63);
      END IF;
    END IF;
  END PROCESS out_2_pipe_in_pipe_process;

  preambleValidIn_4 <= out_2_pipe_in_pipe_reg(64);

  dataValidOut <= dataValidGen_out1_1;

  frameDetOut <= preambleValidIn_4;
