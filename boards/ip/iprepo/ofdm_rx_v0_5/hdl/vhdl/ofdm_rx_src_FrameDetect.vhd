...
ARCHITECTURE rtl OF ofdm_rx_src_FrameDetect IS
  ...
  COMPONENT ofdm_rx_src_Frame_Detection_Valid_Gen
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_12_0                      :   IN    std_logic;
          enable                          :   IN    std_logic;
  ...
  FOR ALL : ofdm_rx_src_Frame_Detection_Valid_Gen
    USE ENTITY work.ofdm_rx_src_Frame_Detection_Valid_Gen(rtl);
...
BEGIN
  ...
  u_Frame_Detection_Valid_Gen : ofdm_rx_src_Frame_Detection_Valid_Gen
    PORT MAP( clk => clk,
              reset => reset,
