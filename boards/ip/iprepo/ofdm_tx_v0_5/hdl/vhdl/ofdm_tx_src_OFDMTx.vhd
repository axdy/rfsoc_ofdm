...
ARCHITECTURE rtl OF ofdm_tx_src_OFDMTx IS
  ...
  SIGNAL preambleValid                    : std_logic;
  SIGNAL dataReady                        : std_logic;
  SIGNAL pilotValid                       : std_logic;
...
BEGIN
  ...
  u_DataGenerator : ofdm_tx_src_DataGenerator
    PORT MAP( clk => clk,
              ...
              preambValOut => preambleValid_1,
              dataValidOut => dataValid_1
              );
