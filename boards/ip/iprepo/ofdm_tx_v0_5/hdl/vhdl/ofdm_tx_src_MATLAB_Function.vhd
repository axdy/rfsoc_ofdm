-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/OFDM_Tx_HW/ofdm_tx_src_MATLAB_Function.vhd
-- Created: 2023-10-16 11:07:11
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: ofdm_tx_src_MATLAB_Function
-- Source Path: OFDM_Tx_HW/OFDMTx/ControlSignalGenerator/MATLAB Function
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY ofdm_tx_src_MATLAB_Function IS
...
END ofdm_tx_src_MATLAB_Function;


ARCHITECTURE rtl OF ofdm_tx_src_MATLAB_Function IS
  ...
  SIGNAL count_frame                      : unsigned(9 DOWNTO 0);  -- ufix10
  ...
  SIGNAL count_frame_next                 : unsigned(9 DOWNTO 0);  -- ufix10
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      ...
      count_frame <= to_unsigned(16#000#, 10);
  ...
  MATLAB_Function_output : PROCESS (count_dataReady, count_frame, count_preamble, enable, reg_enable,
    ...
    VARIABLE add_temp_1 : unsigned(10 DOWNTO 0);
    VARIABLE add_temp_2 : unsigned(7 DOWNTO 0);
  BEGIN
    add_temp := to_unsigned(16#000#, 11);
    add_temp_0 := to_unsigned(16#000#, 10);
    add_temp_1 := to_unsigned(16#000#, 11);
    ...
    CASE state_temp IS
      ...
      WHEN "010" =>
        ...
        ELSE 
          count_dataReady_next <= to_unsigned(16#00#, 7);
        END IF;
        IF count_frame < to_unsigned(16#36F#, 10) THEN 
          add_temp_1 := resize(count_frame, 11) + to_unsigned(16#001#, 11);
          IF add_temp_1(10) /= '0' THEN 
            count_frame_next <= "1111111111";
          ELSE 
            count_frame_next <= add_temp_1(9 DOWNTO 0);
          END IF;
        ELSE 
          count_frame_next <= to_unsigned(16#000#, 10);
          state_temp := to_unsigned(16#3#, 3);
        END IF;
      WHEN "011" =>
        IF count_frame < to_unsigned(16#36F#, 10) THEN 
          add_temp := resize(count_frame, 11) + to_unsigned(16#001#, 11);
          IF add_temp(10) /= '0' THEN 
            count_frame_next <= "1111111111";
          ELSE 
            count_frame_next <= add_temp(9 DOWNTO 0);
          END IF;
        ELSE 
          count_frame_next <= to_unsigned(16#000#, 10);
          state_temp := to_unsigned(16#1#, 3);
